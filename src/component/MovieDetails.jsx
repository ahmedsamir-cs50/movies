        ...
        <div>
            <Row className="justify-content-center">
                <Col md="12" xs="12" sm="12" className="mt-4 ">
                    <div className="card-detalis  d-flex justify-content-around" style={{backgroundColor:"#010002a2"}}>
                        <img
                            className="img-movie w-40 px-4 py-auto "
            ...
            <Row className="justify-content-center">
                <Col md="12" xs="12" sm="12" className="mt-1 ">
                    <div className="card-story  d-flex flex-column align-items-start" style={{backgroundColor:"#010002a2"}}>
